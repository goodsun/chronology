# A Chronicle of Invention
### ── The myth of the emergence of symbols ──

> 和題：『発明の年代記 ── 記号創発の神話』 ／ 語り部の口上：「わたしは、記号」

世界史を、**読んで面白い物語**にする試み。
目的は、世界史の「大まかな流れ」を、楽しみながら、忘れられない形で掴むこと。

> 副題の「**myth（神話）**」は、ただの飾りではない。語り部「わたし」の本当の名は、最後まで読むと分かる。
> ——読み終えてから、もう一度この副題を見てほしい。

## コンセプト

- **群像劇として描く** — 各地域（西アジア／地中海／インド／中国 …）は、互いを知らずに並走する登場人物。全部を見渡せるのは読者だけ。物語の山場は、別々に張られた伏線が**ある瞬間に交わって回収されるとき**。
- **語り部は「わたし」＝進化する記号** — 人類が「遺したい・伝えたい」と願った営みそのものが一人称で語る。`しるし → 文字 → 神話（ミュトス）→ ロゴス → 技術 → …` と姿を変え、名を増やしていく。
- **経緯・仕組みを語る** — 「何が起きたか」より「**なぜ・どうやってそうなったか**」を主役に。村が国になり、国が帝国になる力学を、その都度ちゃんと見せる。
- **壮大な叙事詩風**。

詳しい設計は [`CONCEPT.md`](./CONCEPT.md) を参照。
...
> 🎉 **本編、完結。** さらに、個々の主題を深く掘り下げる「外伝」全26話も完結（下記）。

## 外伝（深掘り）

本編の流れから外れても、立ち止まって深く掘りたい題材を「外伝」として書く。**全26話で完結**。
並び順（構成順）そのものが「**記号の一生**」——〔物語（ミュトス）→ 聖典 → 権力 → 媒体と記録 → 計算 → AI〕——を辿り、本編の主題を外伝のスケールで再演する（→ あとがき／[`docs/gaiden-backlog.md`](./docs/gaiden-backlog.md)）。

| # | ファイル | 主題 |
|---|---|---|
| 其の一 | [`gaiden-01_comparative-mythology.md`](gaiden/gaiden-01_comparative-mythology.md) | 比較神話 ── なぜ、遠い民は、似た物語を紡ぐのか |
| 其の二 | [`gaiden-02_gilgamesh.md`](gaiden/gaiden-02_gilgamesh.md) | ギルガメシュ ── 最古の物語は、すでに「記号は死に勝つ」と知っていた |
| 其の三 | [`gaiden-03_zarathustra.md`](gaiden/gaiden-03_zarathustra.md) | ゾロアスター ── 声で生まれ、文字が救った予言者 |
| 其の四 | [`gaiden-04_the-rig-veda.md`](gaiden/gaiden-04_the-rig-veda.md) | リグ・ヴェーダ ── あえて書かなかった聖典と、身分の起源 |
| 其の五 | [`gaiden-05_the-old-testament.md`](gaiden/gaiden-05_the-old-testament.md) | 旧約聖書 ── 書物を、祖国にした民（ユダヤ教） |
| 其の六 | [`gaiden-06_the-new-testament.md`](gaiden/gaiden-06_the-new-testament.md) | 新約聖書 ── 手紙が、信仰を運ぶ（キリスト教） |
| 其の七 | [`gaiden-07_the-quran.md`](gaiden/gaiden-07_the-quran.md) | クルアーン ── 訳されることを拒んだ、声の聖典（イスラーム） |
| 其の八 | [`gaiden-08_the-transformation-of-buddhism.md`](gaiden/gaiden-08_the-transformation-of-buddhism.md) | 仏教の変容 ── 王子の「方法」が、海を渡って「祈り」になるまで |
| 其の九 | [`gaiden-09_the-kojiki.md`](gaiden/gaiden-09_the-kojiki.md) | 古事記 ── 国家が編んだ神話と、借りた文字で書く格闘 |
...
- [`timeline-source.md`](./timeline-source.md) — 一次資料。原典年表を機械抽出し、各項目に「担当章・地域・本編への掲載有無」を対応づけたもの。
- 出典：世界史年表 <https://www.y-history.net/appendix/appendix-yogo-nenpyo.html>

---

本編（プロローグ〜あとがき）・外伝（全26話）とも完結。
